...
// 	rt->objects[4].light_intensity = 4.f;
// 	create_sphere(rt->objects + 4, 1.f, (t_vec){0, 15, 2}, 0);

// 	rt->objects[0].color = hex_to_rgb(0x5f3bea);
// 	rt->objects[0].smoothness = 1.f;
// 	rt->objects[0].specular_prob = spec;
// 	rt->objects[0].light_intensity = 0.f;
// 	create_cylinder(rt->objects + 0, 3.f, 6.0f, (t_vec){5, 5, -3}, (t_vec){0.5, 1, 1}, 1);

// 	rt->objects[1].color = hex_to_rgb(0xe169a8);
// 	rt->objects[1].smoothness = 1.f;
// 	rt->objects[1].specular_prob = spec;
// 	rt->objects[1].light_intensity = 0.f;
// 	create_cone(rt->objects + 1, 4.f, 6.f, (t_vec){-5, 3, -2}, (t_vec){1, 3, 0}, 1);

// 	rt->objects[2].color = hex_to_rgb(0Xef714d);
// 	rt->objects[2].smoothness = 1.f;
// 	rt->objects[2].specular_prob = spec;
// 	rt->objects[2].light_intensity = 0.f;
// 	create_sphere(rt->objects + 2, 1.5f, (t_vec){0, 3,2}, 1);

// 	rt->objects[3].color = hex_to_rgb(0XFFF0F0);
// 	rt->objects[3].smoothness = 1.f;
// 	rt->objects[3].specular_prob = spec;
// 	rt->objects[3].light_intensity = 0.f;
// 	create_plane(rt->objects + 3, (t_vec){0, 0, 0}, (t_vec){0, 1, 0}, 1);

// 	rt->opt.ambient = .1;
// 	rt->nb_objects = 5;
// 	rt->cam.system.origin = (t_vec){0, 3, 10};
// 	rt->cam.dir = (t_vec){0, 0, -15};
// }
...
// 	rt->opt.ambient = 0.;
// 	rt->nb_objects = 8;
// 	rt->cam.system.origin = (t_vec){0, 3, 0};
// 	rt->cam.dir = (t_vec){0, 0, -15};
// }
...
// 	// static t_sphere sphere1_shape;
// 	// sphere1_shape.center = (t_vec){0, 0, -10};
...
// 	// rect1_shape.center = (t_vec){0, 4.9, -10};
...
// 	// sphereLight.center = (t_vec){0, 6, -10};
...
// 	rt->objects[2].smoothness = smooth;
// 	rt->objects[2].specular_prob = spec;
// 	rt->objects[2].light_intensity = 0.f;
// 	rt->objects[2].shape = (void *)&plane1_shape;
// 	rt->objects[2].intersect = intersect_plane;
...
// 	rt->objects[3].smoothness = smooth;
// 	rt->objects[3].specular_prob = spec;
// 	rt->objects[3].light_intensity = 0.f;
...
// 	plane4_shape.point = (t_vec){0, 0, -15};
// 	rt->objects[4].color = hex_to_rgb(0xFFFFFF);
// 	// rt->objects[4].color = hex_to_rgb(0);
// 	rt->objects[4].smoothness = smooth;
// 	rt->objects[4].specular_prob = spec;
// 	rt->objects[4].light_intensity = 0.f;
...
// 	rt->objects[7].smoothness = smooth;
// 	rt->objects[7].specular_prob = spec;
...
// 	rt->objects[5].smoothness = smooth;
// 	rt->objects[5].specular_prob = spec;
...
// 	rt->objects[6].smoothness = smooth;
// 	rt->objects[6].specular_prob = spec;
...
// 	rt->nb_objects = 7;
// 	rt->opt.ambient = 0.f;
// 	rt->cam.system.origin = (t_vec){0, 2, 0};
// 	rt->cam.dir = (t_vec){0, 0, -15};
// }
